...
- Create a text file named "testfile1" and write "Hello Namexxx" with using vim. Then create a yaml file name "playbook2.yml" and send the "testfile1" to the hosts. 
