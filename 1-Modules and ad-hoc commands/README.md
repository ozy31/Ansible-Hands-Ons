...
$ ansible node1 -m shell -a "echo Hello worldway > /home/ec2-user/testfile2 ; cat testfile2"
```
...
$ ansible all --list-hosts
$ ansible all -m ping -o
$ ansible all -m shell -a "echo Hello worldway > /home/ubuntu/testfile3"
```
...
```bash
$ ansible node3 -m shell -a "echo Hello worldway > /home/ubuntu/testfile3"
$ ansible node1:node2 -m shell -a "echo Hello worldway > /home/ec2-user/testfile3"
```
